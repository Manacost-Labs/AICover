...
export const ResultCard: React.FC<ResultCardProps> = React.memo(({ 
  ...
  return (
    <motion.div 
      ...
      className="relative group aspect-square rounded-[2rem] overflow-hidden bg-zinc-900 border border-white/5 shadow-xl hover:shadow-indigo-500/10 transition-all"
    >
      <img 
        src={url} 
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-zinc-950/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 p-6 flex flex-col justify-end gap-4 translate-y-4 group-hover:translate-y-0">
